...
@RestController
public class AnyOfOrdersApiController implements AnyOfOrdersApi {

    private static final Logger log = LoggerFactory.getLogger(AnyOfOrdersApiController.class);
