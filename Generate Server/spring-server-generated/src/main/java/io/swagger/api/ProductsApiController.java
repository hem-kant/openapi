...
public class ProductsApiController implements ProductsApi {
    ...
    public ResponseEntity<Products> getProductDetails( @Max(1000) @Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema(allowableValues={  }, maximum="1000"
    ...
    public ResponseEntity<List<Products>> getProducts( @Max(1000) @Parameter(in = ParameterIn.QUERY, description = "" ,schema=@Schema(allowableValues={  }, maximum="1000"
)) @Valid @RequestParam(value = "categoryId", required = false) Integer categoryId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Products>>(objectMapper.readValue("[ {\n  \"quantity\" : 1,\n  \"productId\" : 0,\n  \"price\" : 6.0274563,\n  \"name\" : \"name\",\n  \"releseDate\" : \"2000-01-23\",\n  \"categoryName\" : \"categoryName\"\n}, {\n  \"quantity\" : 1,\n  \"productId\" : 0,\n  \"price\" : 6.0274563,\n  \"name\" : \"name\",\n  \"releseDate\" : \"2000-01-23\",\n  \"categoryName\" : \"categoryName\"\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
