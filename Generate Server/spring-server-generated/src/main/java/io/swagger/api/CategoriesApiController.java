...
public class CategoriesApiController implements CategoriesApi {
    ...
    public ResponseEntity<List<Category>> getCategories( @Max(1000) @Parameter(in = ParameterIn.QUERY, description = "" ,schema=@Schema(allowableValues={  }, maximum="1000"
    ...
    public ResponseEntity<Category> getCategoryDetails( @Max(1000) @Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema(allowableValues={  }, maximum="1000"
